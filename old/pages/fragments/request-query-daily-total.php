...
$query = $pdo->prepare("SELECT COUNT(voucherCode) as totalvoucher, voucherType, SUM(voucherAmount) as totalsales FROM vouchers WHERE datePrinted=CURDATE() GROUP BY 2 ORDER BY datePrinted");
$query->execute();
