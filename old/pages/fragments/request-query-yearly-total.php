...
$query = $pdo->prepare("SELECT COUNT(voucherCode) as totalvoucher, voucherType, SUM(voucherAmount) as totalsales FROM vouchers WHERE YEAR(datePrinted)=YEAR(CURRENT_DATE()) GROUP BY 2 ORDER BY datePrinted");
$query->execute();
