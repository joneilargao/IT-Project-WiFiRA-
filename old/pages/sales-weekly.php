...
<?php
/**
* This page displays the sold vouchers for the week.
* 
* @author Darren Sison
		  Joneil Argao
*/
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper" >
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 style = "font-family: special elite; color:#000000">Weekly Sales
              </h1>
...
?>
          ...
          <div class="jumbotron"> 
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
              <?php
include 'fragments/request-query-weekly.php';
?>
            </table>
          </div>
