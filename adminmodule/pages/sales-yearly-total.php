<?php
/**
* sales-yearly-total.php
*
* Displays the total sold vouchers for the year
* 
* @author Darren Sison
* @author Joneil Argao
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper" >
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 style = "font-family: special elite; color:#000000">Total Yearly Sales
              </h1>
          ...
          <a class="btn btn-success" href="#null" onclick="printContent('print')" style="float:right; margin-bottom: 15px;">
            ...
            <div id="print">
              <h3 style = "text-align: center; color:black; font-family: "Arial Black", Gadget, sans-serif;">Yearly Sales
              </h3>
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
                <?php
                include 'fragments/sales-query-yearly-total.php';
                ?>
              </table>
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
              <?php
                include 'fragments/sales-query-total-staff.php';
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
              <?php
                include 'fragments/sales-query-total-kiosk.php';
                if(isset($_POST['request_done'])){
                $rid=$_POST['requestId'];
                $sql = $pdo->prepare("update service_request set request_status=4, end_servicing = curdate()  where request_id = '$rid';");
                $sql->execute();
