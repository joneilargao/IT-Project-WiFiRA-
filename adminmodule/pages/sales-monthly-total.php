<?php
/**
* sales-monthly-total.php
*
* Displays the total sold vouchers for the month
* 
* @author Darren Sison
* @author Joneil Argao
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper" >
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 style = "font-family: special elite; color:#4A8162">Total Monthly Sales</h1>  
            </div>    
            </div>
            <div class="jumbotron"> 
          ...
          <a class="btn btn-success" href="#null" onclick="printContent('print')" style="float:right; margin-bottom: 15px;">
            ...
            <div id="print">
              <h3 style = "text-align: center; color:black; font-family: "Arial Black", Gadget, sans-serif;">Monthly Sales
              </h3>
