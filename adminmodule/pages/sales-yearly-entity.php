        ...
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              ...
              <div>
                <form action="search-voucher-yearly.php" method="get"  style="height:29px; margin-bottom:.5%;">
                  <input type="text" name="sd1" class="tcal" value="" placeholder="xxxxxxxxxx" style="height:29px;"> 
                  <button type="submit"><i class="fa fa-search" style=" margin-top:5px;margin-bottom: 5px; "></i></button>
                </form>
                  
                <form action="sales-yearly-entity.php" method="get"  style="height:29px;margin-right:64%;">
