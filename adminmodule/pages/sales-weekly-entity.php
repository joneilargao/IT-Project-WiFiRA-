<?php
/**
* sales-weekly-entity.php
*
* Displays the weekly sales of specified entity
* 
* @author Joneil Argao
* @author Cyrene Dispo
          ...
          <div class="row">
            <div class="col-md-12">
              <h1 style = "font-family: special elite; color:#4A8162; font-size: 250%;">Weekly Sales</h1>
                <div>
                <form action="search-voucher-weekly.php" method="get"  style="height:29px; margin-bottom:.5%;">
                  <input type="text" name="sd1" class="tcal" value="" placeholder="xxxxxxxxxx" style="height:29px;"> 
                  <button type="submit"><i class="fa fa-search" style=" margin-top:5px; "></i></button>
                </form>
                  
                <form action="sales-weekly-entity.php" method="get"  style="height:29px; margin-right:64%; ">
          ...
          &nbsp;
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
              ...
              <tbody>
                ...
                ((WEEK(vouchers.dateSold)=WEEK(CURRENT_DATE())) AND (MONTH(vouchers.dateSold)=MONTH(CURRENT_DATE())) AND (YEAR(vouchers.dateSold)=YEAR(CURRENT_DATE())))
                and (vouchers.voucherStatus='sold') ORDER BY vouchers.dateSold DESC");
