...
$query1 = $pdo->prepare("SELECT COUNT(voucherCode) as totalVoucherCode, SUM(voucherAmount) as totalAmount FROM vouchers  WHERE YEAR(dateSold)=YEAR(CURRENT_DATE()) and voucherStatus='Sold' ");
$query1->execute();
