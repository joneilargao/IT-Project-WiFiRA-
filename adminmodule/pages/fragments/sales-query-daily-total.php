...
$query = $pdo->prepare("SELECT COUNT(voucherCode) as totalvoucher, voucherType, SUM(voucherAmount) as totalsales FROM vouchers WHERE dateSold=CURDATE() GROUP BY 2 ORDER BY dateSold");
$query->execute();
