...
$query = $pdo->prepare("SELECT voucherCode, voucherType, voucherAmount, datePrinted FROM vouchers WHERE datePrinted=CURDATE() and voucherStatus='sold' order by dateprinted DESC");
$query->execute();
