...
*/
    ...
    $query = $pdo->prepare("SELECT voucherCode, voucherType, voucherAmount, dateSold FROM vouchers WHERE YEAR(dateSold)=YEAR(CURRENT_DATE()) AND voucherStatus='sold' ORDER BY dateSold DESC");
    $query->execute();
