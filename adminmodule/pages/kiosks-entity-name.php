...
?>
              ...
              <form id="search-form" name="search" action="kiosks-entity-name.php" method="get">
...
$result = $pdo->prepare("SELECT kioskId, kioskName, location, ipAddress, kioskStatus FROM kioskmachine WHERE kioskName=:a");
