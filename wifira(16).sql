...
INSERT INTO `accounts` VALUES (1,'Staff','Alfa Leizel Leones','Baguio City','alfa123','000','Enable',NULL,'Visible',0,''),(5,'Admin','Lou Beltran','Baguio City','lou123','444','Enable',NULL,'Visible',0,'');
...
INSERT INTO `kioskmachine` VALUES (101,'WiFiRA Labs','WiFiRA Labs','192.168.9.1','Enable');
...
CREATE TABLE `sales` (
  ...
  KEY `dateSold_idx` (`dateSold`),
  CONSTRAINT `accountNo` FOREIGN KEY (`accountNo`) REFERENCES `accounts` (`accountNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `dateSold` FOREIGN KEY (`dateSold`) REFERENCES `vouchers` (`dateSold`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-04-02 22:24:53
