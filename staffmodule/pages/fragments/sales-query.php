...
$query = $pdo->prepare("SELECT voucherCode, voucherType, voucherAmount, datePrinted FROM vouchers where voucherStatus='sold' AND accountNo='$user_id' order by dateprinted DESC");
$query->execute();
