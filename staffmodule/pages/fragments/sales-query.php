...
$query = $pdo->prepare("SELECT voucherCode, voucherType, voucherAmount, dateSold FROM vouchers where voucherStatus='Sold' AND accountNo='$user_id' order by dateSold DESC");
$query->execute();
