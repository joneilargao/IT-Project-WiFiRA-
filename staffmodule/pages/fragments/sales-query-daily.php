...
$query = $pdo->prepare("SELECT voucherCode, voucherType, voucherAmount, dateSold FROM vouchers WHERE dateSold=CURDATE() and voucherStatus='Sold' AND accountNo='$user_id' order by dateSold DESC");
$query->execute();
