    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper" >
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 style = "font-family: special elite; color:#4A8162; font-size: 250%;">Sold Vouchers</h1>
              <div>
          ...
          <div class="jumbotron"> 
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example" name="anothercontent">
                ...
                $result = $pdo->prepare("SELECT * FROM vouchers where (voucherCode =:a) and (voucherStatus='Sold') AND (accountNo='$user_id')");
                ...
                ?>
                            <tr class="record">
                              ...
                              <td>
                                <?php echo '<a href="fragments/vouchers-sold.php?su1='.$row['voucherId'].'"><button class="btn">Unsold</button></a>'; 
                                ?>
                              </td>
                </tr>
                <?php
