          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="search-voucher-monthly.php" method="get" >
                ...
                <input type="text" name="sm1" class="tcal" value="" placeholder="xxxxxxxxxx" style="height:29px;" >
...
((MONTH(vouchers.datePrinted)=MONTH(CURRENT_DATE())) AND (YEAR(vouchers.datePrinted)=YEAR(CURRENT_DATE()))) and (vouchers.voucherStatus='sold') ORDER BY vouchers.datePrinted DESC");
