 ...
 */
$controlleruser     = 'SLU_OJT'; // the user name for access to the UniFi Controller
$controllerpassword = 'Password1'; // the password for access to the UniFi Controller
$controllerurl      = 'https://unifi.wifirawireless.com:8443'; // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443'
